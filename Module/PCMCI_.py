...
"""
# 构建 dataset 文件夹的路径
dataset_dir = os.path.join(current_dir, '..', 'dataset/Causal_simulation_data_2')
# 确保目标路径存在
...
filename3 = f'pcmci_results_{tau_str}_{alpha_str}.npz'
pickle_file = os.path.join(output_dir, 'pcmci_results_full.pkl')
